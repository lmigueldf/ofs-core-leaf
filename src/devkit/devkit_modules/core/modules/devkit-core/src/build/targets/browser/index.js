...
exports.init = function (api, app, config) {
  ...
  INITIAL_IMPORT = config.argv.initialImport != void 0 ? 'devkit.browser.' + config.argv.initialImport :  'devkit.browser.launchClient';
  config.initialImport = INITIAL_IMPORT;

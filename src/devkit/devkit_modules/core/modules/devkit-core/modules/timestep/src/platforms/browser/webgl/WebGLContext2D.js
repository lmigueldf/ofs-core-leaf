...
var GLManager = Class(function () {
    ...
    this.init = function () {
        ...
        this.isSupported = webglSupported; // OFS CHANGE 26072018
        ...
        var contextOpts = (CONFIG.modules.extended && CONFIG.modules.extended.webGLContext) || {
            alpha: false,
            premultipliedAlpha: false,
            preserveDrawingBuffer: true
        };
        this._canvas.getWebGLContext = this._canvas.getContext.bind(this._canvas, 'webgl', contextOpts);
    ...
    this.initGL = function () {
        ...
        var _index = 1000;
        GLOBAL.registerShader = bind(this, function (type, _shader) {
            this.shaders[_index] = new _shader({gl: gl});
            RENDER_MODES[type] = _index;
        });
    ...
    this.addToBatch = function (state, textureId) {
        ...
        if (stateChanged) {
            ...
            if (textureId === -1) {
                ...
                queueObject.renderMode = RENDER_MODES[filter.getType()] || RENDER_MODES.Default;
            } else {
...
var Context2D = Class(function () {
    ...
    this.circle = function (x, y, radius, clip) {
        // TODO
    };

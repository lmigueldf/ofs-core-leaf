...
exports = Class(View, function (supr) {
    ...
    this.stopScrolling = function () {
        this._anim && this._anim.clear().now({}, 1);
    };
    ...
    this.onDragStop = function (dragEvt, selectEvt) {
        ...
        if (this._opts.inertia) {
            ...
            //var velocity = Math.max(this._bounceRadius, delta.getMagnitude());
            ...
            if (distance
                && ((animateY && this._opts.scrollY) || (animateX && this._opts.scrollX))) {
                this._anim.clear().now(bind(this, function (tt, t) {
                    this.setOffset(
                        offset.x + delta.x * tt,
                        offset.y + delta.y * tt);
    ...
    this._endBounce = function () {
        ...
        this._anim.clear().now(bind(this, function (tt, t) {
            this.setOffset(
                offset.x + dx * tt,
                offset.y + dy * tt);
        }), 350, animate.easeInOut).then(bind(this, function () {
